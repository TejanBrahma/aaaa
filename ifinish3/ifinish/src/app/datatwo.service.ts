...
import { tickdatatwo } from './app.component';
...
export class DatatwoService {
  ...
  ticketDataTwo: tickdatatwo[] = [
    {
      raceid: 7,
      race: 'DBZ 4K Run',
      quan: 0,
      amount: 599,
      imageSrc: 'https://i.picsum.photos/id/866/536/354.jpg?hmac=tGofDTV7tl2rprappPzKFiZ9vDh5MKj39oa2D--gqhA',
    },
    {
      raceid: 8,
      race: 'OP 2K Run',
      quan: 0,
      amount: 499,
      // imageSrc: 'https://ts-production.imgix.net/images/mobile-cover-uploaded/e3607586-b3f4-497a-a2ed-33bac038a45a.jpg?auto=compress,format&w=375&h=200',
      imageSrc: 'https://i.picsum.photos/id/237/536/354.jpg?hmac=i0yVXW1ORpyCZpQ-CknuyV-jbtU7_x9EBQVhvT5aRr0',
