...
import { ITicketDataTwo } from '../tickettwo.service';
...
export class RegistertwoComponent implements OnInit {
  ...
  ticketCounter$!: Observable<ITicketDataTwo[] | null>;

  constructor(
    private ticketServiceTwo: TicketServiceTwo,
  ...
  ngOnInit() {
    ...
    // });
    this.ticketCounter$ = this.ticketServiceTwo.countTicket$.pipe(
      map((rowData: ITicketDataTwo[]) => {
  ...
  loadForm(filterData:any) {
    ...
    this.ticketServiceTwo.count = totalTickets;
  ...
  get getCounter() {
    return this.ticketServiceTwo.count;
  }
  onChangeTickets(e:any, eventRowData: ITicketDataTwo) {
  ...
  onNext(event:any) {
    ...
    if (this.currentTicket === this.ticketServiceTwo.count - 1) {
    ...
    this.ticketServiceTwo.currentTicket.next(this.currentTicket);
  }
  ...
  onSubmit() {
    ...
    this.ticketServiceTwo.finalData.next(this.form.value);
    this.router.navigate(['summarytwo']);
    this.ticketEventName = '';
  }
  onReset() {
    // reset whole form back to initial state
    this.submitted = false;
    this.ticketServiceTwo.count = 0;
    this.currentTicket = 0;
  }
  ...
  onBackNavigation() {
    this.router.navigate(['eventtabletwo/:id']);
  }
